...
const Page = () => {
    ...
    return (
        <form onSubmit={onSubmit} className='pt-5 px-5 sm:pt-12 sm:pl-16'>
            ...
            <input name='title' value={data.title} onChange={onchangeHandler} className='w-full sm:w-[500px] mt-4 px-4 py-3 border' type="text" placeholder='Type here' id="" required />
            <p className='text-xl mt-4'>Blog description</p>
            <textarea name="description" onChange={onchangeHandler} value={data.description} className='w-full sm:w-[500px] mt-4 px-4 py-3 border' type="text" placeholder='Write content here' id="" required />
